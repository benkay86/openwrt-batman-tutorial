...
![image](screenshot-firmware-selector-default.png)

Now, click to expand the menu `Customize installed packages and/or first boot script`. 

![image](screenshot-firmware-selector-packages.png)
...
![image](screenshot-firmware-selector-progress-1.png)
...
![image](screenshot-firmware-selector-progress-4.png)

Now you can download the customized sysupgrade image, which includes your custom package selection.

![image](screenshot-firmware-selector-sysupgrade.png)
...
![image](screenshot-luci-menubar.png)
...
![image](screenshot-luci-opkg.png)
...
![image](screenshot-network-interfaces.png)

Click on the `Add new interface...` button.

![image](screenshot-new-batman-device.png)
...
![image](screenshot-create-batman-interface.png)
...
![image](screenshot-batmesh-edit-general.png)
...
![image](screenshot-network-devices.png)
...
![image](screenshot-configure-br-lan.png)
...
![image](screenshot-wireless-mesh-general.png)
...
![image](screenshot-wireless-mesh-security.png)
...
![image](screenshot-wireless-mesh-advanced.png)
...
![image](screenshot-wireless-ap-general.png)
...
![image](screenshot-wireless-ap-wlan-roaming.png)
...
![image](screenshot-lan-static-ip.png)
...
![image](screenshot-lan-static-ip-gateway.png)
...
![image](screenshot-lan-static-ip-dns.png)
...
![image](screenshot-lan-static-ip-apply.png)
...
![image](screenshot-system-startup.png)
...
![image](screenshot-wan-bridge.png)
...
![image](screenshot-create-wan6.png)
...
![image](screenshot-wan6-general.png)
...
![image](screenshot-wan6-advanced.png)
